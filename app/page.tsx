  ...
  const productos = useMemo(() => [
    {
      ...
      price: '1.499€',
      img: 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=400&auto=format&fit=crop'
    },
    {
      name: 'Ordenador Oficina',
      price: '900€',
      img: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=400&auto=format&fit=crop'
    },
    {
      name: 'MacBook Pro',
      price: '2.400€',
    ...
    },
    {
      ...
      price: '250€',
      img: 'https://images.unsplash.com/photo-1580894908361-967195033215?w=400&auto=format&fit=crop'
    }
  ], [])
  ...
  return (
    <div style={{ fontFamily: 'sans-serif' }}>
      ...
      >
        ...
        >
          ...
          <div
            ...
            onClick={() => window.open('https://wa.me/34613499398', '_blank')}
          >
      ...
      >
        ...
        >
          <div style={{ maxWidth: 600 }}>
            <h1 style={{ fontSize: isMobile ? 28 : 36 }}>
              Trabajamos con miles de negocios
            </h1>

            <p>
              Ayudamos a empresas a conseguir más clientes mediante páginas web,
              sistemas CRM y automatización de marketing.
            </p>

            <p>
              Creamos webs que generan contactos reales cada semana
              <br />
              y hacemos marketing para tu empresa
            </p>
          ...
          <div style={{ maxWidth: 500 }}>
            ...
            >
              Consigue más clientes para tu negocio automáticamente
            </h2>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <p>✔ Más llamadas</p>
        <p>✔ Más ventas</p>
        <p>✔ Gestión profesional de redes sociales</p>
        <p>✔ Captación de leads para publicidad</p>
        <p>✔ Automatización de clientes</p>
        <p>✔ Marketing profesional para empresas</p>
      </div>
      ...
      >
        ...
        >
          Diseñamos y desarrollamos páginas web con tecnología avanzada orientada
          a resultados, enfocadas en la captación de clientes reales para tu negocio.

          <br /><br />

          No solo creamos tu web, implementamos sistemas de marketing digital
          que trabajan por ti, permitiéndote gestionar los contactos que entran,
          aumentar tus ventas y posicionarte de forma sólida en internet.
        </p>
      </div>

      <div style={{ display: 'flex', justifyContent: 'center', padding: '20px' }}>
        <img
          src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=600&auto=format&fit=crop"
          alt="Empresarios"
          style={{
            width: '100%',
            maxWidth: 700,
      ...
      >
        <img
          src="https://www.workwearexpress.com/media/catalog/category/202504WorkwearEssentialsL2.png"
          alt="Ropa de trabajo personalizada"
          style={{
            width: '100%',
            maxWidth: 300,
            marginBottom: 20,
        ...
        <h3 style={{ fontSize: 22, marginBottom: 10 }}>
          Encarga tu ropa de trabajo personalizada
        </h3>
      ...
      <div style={{ padding: '40px 20px', textAlign: 'center' }}>
        ...
        >
          ...
          >
            <p>✔ Web profesional</p>
            <p>✔ Activación rápida</p>
            <p>✔ Estudios de leads</p>
            <p>✔ Marketing básico</p>
          ...
          >
            ...
            <p>✔ Marketing personalizado</p>
            <p>✔ Optimización de leads</p>
          ...
          >
            <p>✔ Todo lo anterior</p>
            <p>✔ Estrategia avanzada</p>
            <p>✔ Setup personalizado + Demo</p>
        ...
        <p style={{ marginTop: 20 }}>
          Contacte con operador de ventas para ofertas exclusivas y personalizadas
        </p>
      </div>
