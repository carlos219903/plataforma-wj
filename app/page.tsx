...
export default function Home() {
  ...
  // useSearchParams solo dentro de useEffect para evitar errores de prerender
  const searchParams = useSearchParams()
  const clienteId = typeof window !== 'undefined' ? (searchParams.get('cliente_id') || '206a762e-1038-4624-8772-ab4b9cd8b068') : ''
  ...
  // Detectar si es mobile y actualizar on resize
  useEffect(() => {
  ...
  return (
    <div style={{fontFamily:'sans-serif'}}>
      ...
      <div style={{backgroundImage:'url(https://images.unsplash.com/photo-1518770660439-4636190af475)',backgroundSize:'cover',backgroundPosition:'center',color:'white',padding:'60px 20px'}}>
        <div style={{display:'flex',flexDirection: isMobile ? 'column' : 'row',justifyContent:'space-between',alignItems:'center',gap:30,textAlign: isMobile ? 'center' : 'left'}}>
          ...
          <div style={{maxWidth:500}}>
            <h2 style={{fontSize: isMobile ? 26 : 38,fontWeight:800,color:'white',lineHeight:1.2}}>
      ...
      <div style={{padding:'30px',textAlign:'center',backgroundColor:'#0070f3',color:'white'}}>
        ...
        <p>✔ Más llamadas</p>
        <p>✔ Más ventas</p>
        <p>✔ Sin depender de redes sociales</p>
        <p>✔ Gestionamos tu marketing de forma profesional</p>
      </div>

      <div style={{padding:'30px',maxWidth:700,margin:'auto',textAlign:'center'}}>
        <p style={{fontSize:16, lineHeight:1.6}}>
          Diseñamos y desarrollamos páginas web con tecnología avanzada orientada a resultados,
          enfocadas en la captación de clientes reales para tu negocio.
          <br/><br/>
          No solo creamos tu web, implementamos sistemas de marketing digital que trabajan por ti,
          permitiéndote gestionar los contactos que entran, aumentar tus ventas y posicionarte
          de forma sólida en internet.
        </p>
      </div>
      ...
      <div ref={formRef} style={{padding:'30px',maxWidth:500,margin:'auto',border:'2px solid #0070f3',borderRadius:10,backgroundColor:'#0070f3'}}>
        ...
        <textarea
          ...
          rows={3}
          style={{width:'100%',padding:10,backgroundColor:'white',resize:'none',overflow:'hidden'}}
        />
        <br/><br/>
        <button onClick={enviarLead} style={{width:'100%',padding:12,backgroundColor:'#0a2540',color:'white',border:'none',cursor:'pointer',borderRadius:5}}>
          Quiero clientes
        </button>
      </div>
      ...
      <div style={{backgroundColor:'#0a2540',padding:'30px 20px',color:'white',textAlign:'center',marginTop:40}}>
        ...
        <p style={{fontSize:11, opacity:0.7, marginTop:20, lineHeight:1.5}}>
          Información legal: Los servicios ofrecidos corresponden a soluciones digitales personalizadas.
          Los resultados pueden variar en función de múltiples factores externos al servicio.
          Debido a la naturaleza del servicio y su activación inmediata, no se contemplan reembolsos una vez iniciado.
        </p>
      </div>
